...
<div class="container">
		  ...
		  <div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav">
		      ...
		      <li class="active"><a href="myWishList.jsp">My Wishlist</a></li>
		    </ul>
	...
	<%  
		if(session.getAttribute("user") == null){
			...
			out.println("<h3>You have the following items in your wishlist:</h3>");
	%>
		<div class="row">
	...
	<%
			...
			if(session.getAttribute("wishlist") != null){
				...
				ArrayList<ProductBean> pList = wishlist.getWishlist();
				...
				for (int i = 0; i < pList.size(); i++) {
					...
					out.println("<div class='col-sm-4'>"
								+"<input type='submit' name='action' value='Update List' class='btn btn-primary'>"
								+"<input type='submit' name='action' value='Remove' class='btn btn-info'><input type='hidden' name='wish_id' value='"+i+"'>"
								+"<input type='submit' name='action' value='Buy now' class='btn btn-default'></div>");
